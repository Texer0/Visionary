function ProjectCard({id}) {
    ...
    return (
        ...
        onClick={() => handleProjectButton(id)}>
            <div>
                <h3 className="w-72 rounded-t shadow-md overflow-hidden 
                text-xl font-semibold opacity-100 bg-gray-600 bg-opacity-30 text-white p-4 text-center">Nombre no disponible {id}</h3>
            </div>
